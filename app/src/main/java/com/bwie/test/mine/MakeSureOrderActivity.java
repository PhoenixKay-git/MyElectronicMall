...
import com.bwie.test.mine.adapter.MakeSureOrderAdapter;
import com.bwie.test.mine.contract.MakeSureOrderContract;
import com.bwie.test.mine.presenter.MakeSureOrderPresenter;
...
public class MakeSureOrderActivity extends BaseActivity<MakeSureOrderPresenter> implements MakeSureOrderContract.View, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //先去获取常用收货地址列表
        if (mPresenter != null) {
            mPresenter.getAddrsess(getUid(), getToken());
        }
    }
    ...
    @Override
    public void addressSuccess(List<AddrsBean.DataBean> list) {
    ...
    @Override
    public void createOderSuccess(String s) {
    ...
    private void initView() {
        ...
        mDetailImageBack.setOnClickListener( this );
    }
