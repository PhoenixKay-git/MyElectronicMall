package com.bwie.test.mine.adapter;
...
public class MakeSureOrderAdapter extends BaseExpandableListAdapter{
    ...
    public MakeSureOrderAdapter(Context context, List<SellerBean> groupList, List<List<GetCartsBean.DataBean.ListBean>> childList) {
